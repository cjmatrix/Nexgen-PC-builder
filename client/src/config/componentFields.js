...
export const CATEGORY_SPECS = {
  cpu: [
    { name: "socket", label: "Socket Type", type: "text", placeholder: "e.g., LGA1700" },
    { name: "cores", label: "Cores", type: "number" },
    { name: "threads", label: "Threads", type: "number" },
    { name: "wattage", label: "TDP (Watts)", type: "number" },
    { name: "integratedGraphics", label: "Integrated Graphics?", type: "checkbox" },
  ],
  gpu: [
    { name: "vram_gb", label: "VRAM (GB)", type: "number" },
    { name: "length_mm", label: "Length (mm)", type: "number" },
    { name: "wattage", label: "TDP (Watts)", type: "number" },
    { name: "recommendedPsuWattage", label: "Rec. PSU (Watts)", type: "number" },
    { name: "boostClock_mhz", label: "Boost Clock (MHz)", type: "number" },
  ],
  motherboard: [
    { name: "socket", label: "Socket Type", type: "text" },
    { name: "formFactor", label: "Form Factor", type: "select", options: ["ATX", "mATX", "ITX"] },
    { name: "ramType", label: "RAM Type", type: "select", options: ["DDR4", "DDR5"] },
    { name: "ramSlots", label: "RAM Slots", type: "number" },
    { name: "wifi", label: "Has Wi-Fi?", type: "checkbox" },
  ],
  ram: [
    { name: "ramType", label: "Type", type: "select", options: ["DDR4", "DDR5"] },
    { name: "capacity_gb", label: "Total Capacity (GB)", type: "number" },
    { name: "speed_mhz", label: "Speed (MHz)", type: "number" },
    { name: "modules", label: "Modules", type: "text", placeholder: "e.g., 2x16GB" },
  ],
  storage: [
    { name: "storageType", label: "Type", type: "select", options: ["SSD-NVME", "SSD-SATA", "HDD"] },
  ...
  psu: [
    ...
    { name: "efficiencyRating", label: "Efficiency", type: "select", options: ["Bronze", "Gold", "Platinum"] },
    { name: "modular", label: "Modular", type: "select", options: ["Full", "Semi", "Non"] },
  ],
  cooler: [
    { name: "coolerType", label: "Type", type: "select", options: ["Air", "Liquid"] },
    { name: "radiatorSize_mm", label: "Size (mm)", type: "number", placeholder: "0 if Air" },
  ]
};