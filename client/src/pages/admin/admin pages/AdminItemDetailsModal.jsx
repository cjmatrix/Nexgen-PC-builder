...
const AdminItemDetailsModal = ({ isOpen, onClose, items }) => {
  ...
  const modifiedComponents=Object.fromEntries(Object.entries(components).map(([key,value])=>{
    console.log(value)
          ...
          <div className="flex items-center gap-2">
            {(item.isCustomBuild || item.isAiBuild) && (
              <button
                ...
                className="bg-purple-600 text-white px-3 py-1.5 rounded-lg flex items-center gap-1.5 hover:bg-purple-700 text-sm font-medium transition-colors shadow-sm whitespace-nowrap"
              >
