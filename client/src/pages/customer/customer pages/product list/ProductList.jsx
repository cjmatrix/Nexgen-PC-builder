            ...
            {items.map((product, index) => {
              ...
              return (
                <div
                  ...
                  className="product-card translate-y-[50px] opacity-0 group bg-white rounded-2xl shadow-sm hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 border border-gray-100 overflow-hidden flex flex-col cursor-pointer"
                >
