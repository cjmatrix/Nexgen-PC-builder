...
const UserOrderDetails = ({ isOpen, onClose, order }) => {
  ...
  return ReactDOM.createPortal(
    ...
    <div ref={containerRef}>
      <div
        ref={overlayRef}
        className={` fixed inset-0 z-50 flex items-center justify-center ${!isItemDetailsOpen && " bg-black/50" } backdrop-blur-sm p-4 opacity-0`}
      >
        <CustomModal
        ...
        <div
          ref={modalRef}
          className={`bg-white rounded-2xl shadow-xl w-full max-w-3xl max-h-[90vh] overflow-hidden flex flex-col opacity-0 scale-[0.8] translate-y-5 ${
