    ...
    <>
      ...
      {ReactDOM.createPortal(
        <div ref={containerRef}>
          <div
            ref={overlayRef}
            className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm opacity-0"
            onClick={onClose}
          >
            <div
              ref={modalRef}
              className="bg-white rounded-2xl w-full max-w-md shadow-2xl p-6 opacity-0 scale-[0.8] translate-y-5"
